...
def _to_python_value(value: Any) -> Any:
    """把 pandas / NumPy 标量递归转换为可 JSON 序列化的普通 Python 值。"""
...
def get_available_categories(base_dir: Path) -> list[str]:
    """返回 API 和看板都可使用的品类筛选值。"""
    category_df = _read_csv(base_dir / "data" / "category_analysis.csv")
